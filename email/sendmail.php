...
class Mailer
{
    public function dat_hang($tieu_de, $noi_dung, $mail_dat_hang)
    {
        ...
        try {
            ...
            $mail->Username = 'tuanpa20520@gmail.com';                 // SMTP username
            $mail->Password = 'aqlpnbgzrznzzioa';                          // SMTP password
            $mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
            $mail->Port = 587;                                    // TCP port to connect to

            //Recipients
            $mail->setFrom('tuanpa20520@gmail.com', 'Beeta-Store');
            $mail->addAddress($mail_dat_hang, '');     // Add a recipient
            // $mail->addAddress('phamanhtuan1628@gmail.com', 'Anh Tuấn');               // Name is optional

            // $mail->addReplyTo('info@example.com', 'Information');

            $mail->addCC('phamanhtuan1628@gmail.com');
