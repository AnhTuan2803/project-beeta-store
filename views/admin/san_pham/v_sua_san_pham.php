            ...
            <div class="col-lg-12">
                <form action="index.php?act=cap_nhat_san_pham" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card mb-3 mb-lg-5">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="ten_sp" id="productNameLabel" placeholder="Tên sản phẩm" required value="<?=$ten_sp?>">
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                                    <!-- Form Group -->
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="ngay_tao" id="" placeholder="" aria-label="eg. 348121032" required value="<?=$ngay_tao?>">
                                    </div>
                                    <!-- End Form Group -->
                                </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="don_gia" id="weightLabel" placeholder="Đơn giá..." aria-label="0.0" required value="<?=$don_gia?>">
                            ...
                            <div class="quill-custom">
                                ...
                                <textarea class="form-control" style="height:120px;" placeholder="Mô tả ngắn..." name="mo_ta_ngan"><?=$mo_ta_ngan?></textarea>
                            </div>
                            <!-- End Quill -->
                            <div class="quill-custom mt-4">
                                <label class="input-label">Mô tả chi tiết</label>
                                <textarea class="form-control" style="height:220px;" placeholder="Mô tả chi tiết..." name="mo_ta_chi_tiet"><?=$mo_ta_chi_tiet?></textarea>
                            </div>
                        </div>
                        <!-- Body -->
                    </div>
                    ...
                    <div class="card mb-3 mb-lg-5">
                        ...
                        <div class="ml-4 mb-4">
                            <input type="hidden" name="id" id="" value="<?php if(isset($id_sp)&&($id_sp > 0)) echo $id_sp ;?>">
